...
- [english_pronouns.py](https://github.com/aieng-lab/gradiend/blob/main/gradiend/examples/english_pronouns.py) — English pronouns (3SG vs 3PL); loads data from `data_creation_pronouns` output. Optional `class_merge_map` for number/person (e.g. singular vs plural).
